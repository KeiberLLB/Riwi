...
console.log(
  `El resultado de la suma de ${numero1} y ${numero2} = ${resultado}`
);

//Resta
resultado = numero1 - numero2;
console.log(
  `El resultado de la resta de ${numero1} y ${numero2} = ${resultado}`
);

//Multiplicación
resultado = numero1 * numero2;
console.log(
  `El resultado de la multiplicación de ${numero1} y ${numero2} = ${resultado}`
);

//División
resultado = numero1 / numero2;
console.log(
  `El resultado de la división de ${numero1} y ${numero2} = ${resultado}`
);

//Modulo
resultado = numero1 % numero2;
console.log(
  `El Residuo de la división de ${numero1} y ${numero2} = ${resultado}`
);
