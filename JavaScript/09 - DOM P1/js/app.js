...
const urlImg =
  "https://media.licdn.com/dms/image/D4E0BAQE6QGDqCKQ17A/company-logo_200_200/0/1682093032999?e=2147483647&v=beta&t=KsvWNfuoy_aqLTU56z2X09ZdedyedcfmLN1faCGUtZk";
...
setInterval(() => {
  ...
  body.style.backgroundImage = `linear-gradient(90deg, ${
    listaDeColores[colorRandom]
  }, ${listaDeColores[colorRandom - 1]} `;
}, 1000);
...
const coders = [
  ...
  { nombre: "Tomas", edad: 26, ciudad: "Medellin", genero: "M" },
];
...
function cargarDatos() {
  ...
  // Reinicio el tbody
  tbody.innerHTML = "";
  coders.forEach((estudiante, inder) => {
